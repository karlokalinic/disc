...
{
	[Pragma]
	public class ConversationLoggerPageSystem : SingletonComponent<ConversationLoggerPageSystem>
	{
		...
		protected static FinalEntry finalEntry;
		...
		public event Action OnAfterConversationEnded
		{
			[CompilerGenerated]
			add
			{
		...
		public void OnDialoguePageOpen(SunshineContinueButton continueButton, ScrollDown scrollDown, Image portraitImage, AbstractDialogueUI unityUI, ScrollRect scrollControler, LogRenderer logRenderer, ContinueResponseTogglePageSystem responseToggle)
		{
		}
